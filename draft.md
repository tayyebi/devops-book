...
# Linux & Canonical's Ubuntu Family



# IDEs, Database GUIs, & Code Editors

## IDE: Microsoft Visual Studio Code (Different to Microsoft Visual Studio)

### Installation

#### Download deb file

To install Microsoft Visual Studio Code (AKA vscode) please navigate to it's [download page](https://code.visualstudio.com "Microsoft's Light IDE named Visual Studio Code download page").
...
# First hands on Linux

## Debian-based such as Debian, Ubuntu, Xubuntu, Ubuntu Studio, and Ubuntu Mate

To make the machine ready to install new software packages, run:
